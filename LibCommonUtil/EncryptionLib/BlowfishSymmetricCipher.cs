// =====================================================================================
// This class is the implementation of the Blowfish symmetric cipher algorithm.
// This class was built based on .Net Framework 2.0.
//
// BlowfishSymmetricCipher.cs
//
// Original source:
...
{
	sealed public class BlowfishSymmetricCipher
    {
        /***********************************************************************************************************/

        
        #region ------ Define Private Constants ------
        ...
        #endregion ------ Define Private Constants ------


        /***********************************************************************************************************/


        #region ------ Define Static Readonly Variables ------


        private readonly static uint[] _P = 
		{
        ...
        private readonly static uint[,] _S = 
		{
			{
        ...
        #endregion ------ Define Private Static Readonly Variables ------
		...
		public void Decipher(ref byte[] data, int length)
		{
            uint xl, xr;
