// =====================================================================================
// This class is the implementation of the Rijndael/AES symmetric cipher algorithm.
// This class was built based on .Net Framework 2.0.
//
// RijndaelSymmetricCipher.cs
//
// Original source:
...
namespace LibCommonUtil
{
    ...
    /// </summary>
    public sealed class RijndaelSymmetricCipher
    {
        /***********************************************************************************************************/
        ...
        /// Hash algorithm used to generate password.
        /// Allowed values are: "MD5" and "SHA1".
        ...
        /// Allowed values are: 128, 192, and 256. 
        ...
        public static string Encrypt(string plainText,
                                     ...
                                     int keySize)
        {
            // Convert strings into byte arrays. Let assume that strings only contain ASCII codes.
            // If strings include Unicode characters, use Unicode, UTF7, or UTF8 encoding.
            byte[] initVectorBytes = Encoding.ASCII.GetBytes(initVector);
            byte[] saltValueBytes = Encoding.ASCII.GetBytes(saltValue);

            // Convert plaintext into a byte array. Let assume that plaintext contains UTF8-encoded characters.
            byte[] plainTextBytes = Encoding.UTF8.GetBytes(plainText);

            // First, a password must be created, from which the key will be derived.
        ...
        /// </returns>
        /// <remarks>
        /// Most of the logic in this function is similar to the Encrypt logic.
        ...
        public static string Decrypt(string cipherText,
                                     ...
                                     int keySize)
        {
            // Convert strings defining encryption key characteristics into bytearrays.
            // If strings include Unicode characters, use Unicode, UTF7, or UTF8 encoding.
            byte[] initVectorBytes = Encoding.ASCII.GetBytes(initVector);
            byte[] saltValueBytes = Encoding.ASCII.GetBytes(saltValue);
            ...
            // Since at this point the size of decrypted data has not yet been known, thus,
