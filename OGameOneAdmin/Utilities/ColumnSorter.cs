...
namespace OGameOneAdmin.Utilities
{
    /// <summary>
    ...
    public class ListViewColumnSorter : IComparer
    {
        ...
        public int DateTimeColumnIndex = -1;
        ...
        public int Compare(object x, object y)
        {
            ...
            if (ColumnToSort == DateTimeColumnIndex)
            {
                compareResult = ObjectCompare.CompareDateTime(listviewX.SubItems[ColumnToSort].Text, listviewY.SubItems[ColumnToSort].Text);
            }
    ...
    public class NumberCaseInsensitiveComparer : CaseInsensitiveComparer
    {
        ...
        public int CompareDateTime(object x, object y)
        {
            try
            {
                DateTime firstDate;
                ...
                if (string.IsNullOrEmpty(((string)x)))
                    ...
                    firstDate = DateTime.Parse((string)x);

                if (string.IsNullOrEmpty(((string)y)))
                    secondDate = DateTime.MinValue;
                else
                    secondDate = DateTime.Parse((string)y);
